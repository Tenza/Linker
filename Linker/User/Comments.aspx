<%@ Page Title="" Language="C#" MasterPageFile="~/Linker.Master" AutoEventWireup="true" CodeBehind="Comments.aspx.cs" Inherits="Linker.User.Comments" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        function validate()
        {
            var v_comment = document.getElementById("txt_add_comment").value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <center>
        ...
        <% if (qs_sec == "images") { %>
                ...
                <img src='<%= load_content() %>' alt="" style="max-height: 500px; max-width: 500px;" />

        <%  } else if (qs_sec == "videos") { %>

                 <iframe width="500" 
                     height="335" 
                     src="https://www.youtube-nocookie.com/embed/<%= load_content() %>?rel=0&amp;hd=1" frameborder="0" allowfullscreen>
                 </iframe>
        ...
        <asp:TextBox ID="txt_description" 
            ...
            Style="width: 500px; max-width: 900px; height: 50px; color: White; overflow: hidden;">
        </asp:TextBox>
        <br />
        <br />
        ...
        <table width="55%" cellspacing="5">
            <tr>
                <td style="padding-right: 5px">Comment:<br />
                    <asp:TextBox ID="txt_add_comment" 
                        runat="server" 
                        ClientIDMode="Static" 
                        TextMode="MultiLine" 
                        MaxLength="8000" 
